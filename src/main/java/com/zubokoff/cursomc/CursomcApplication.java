...
import com.zubokoff.cursomc.domain.Cidade;
...
import com.zubokoff.cursomc.domain.enums.TipoCliente;
import com.zubokoff.cursomc.repositories.CategoriaRepository;
import com.zubokoff.cursomc.repositories.CidadeRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		cli1.getTelefones().addAll(Arrays.asList("36863909", "936863909"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "06420130", c1, cli1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "06420130", c2, cli1);
